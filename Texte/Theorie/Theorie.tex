...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE,RO]{ \textit{Bachelorarbeit Leon Hetzel}}
...
\usepackage{lmodern}
\usepackage[colorlinks]{hyperref}				% Liks in Dokument
\usepackage{bbold} 									% Einheitsoperator
\usepackage{dsfont}									% Einheitsoperator
% \usepackage{mathtools}								% := Zeichen
\usepackage{textcomp}								% ' gerade 
...
\newcommand{\com}[2]{[\, #1, #2 \,]}
\newcommand\numberthis{\stepcounter{equation}  \tag{\theequation}} %  \thesubsection \,
